...
data_dir = '/media/phoebeyou/My Passport/Spencers_Cat_Data/data/';
...
% [0 220] is the range of frequency intersted, can be defined by one FOI,
% such as 20/23 Hz and 200Hz
...
anp_figures_ph(dir_sec, filename_header, plotopts(5))
