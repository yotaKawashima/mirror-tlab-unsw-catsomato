...
% effects. 2) only significant F2 main effects. 3) only significant
% interaction. 4) ....
% Also show the proportion matrix.
...
for figid = 1:8
    ...
    print(gcf,imgtype,['Fig3_P', title_list{figid} ,dt])
end
