% adapted from /media/rannee/UNSW_Cat_Somatos/scripts/28Jul17/fstat_fig4_plotter.m

% data directory
data_dir = '/media/rannee/UNSW_Cat_Somatos/data/collated_data/anoved_rsampsl_biprref_evkresp_cmtspwr_adatout_fstonly';
