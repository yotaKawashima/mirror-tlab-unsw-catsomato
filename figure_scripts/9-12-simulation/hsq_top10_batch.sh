...
#SBATCH --job-name=hsq_top10 						# Job name
...
#SBATCH --output=./massiveOutput/hsq_top10_%j.log    # Standard output and error log
...
matlab -nodisplay -r "model_hsq_fit_massive_v2($channel_id, $area_id); exit;"
