function model_rect_fit_massive_v3(channel_id, area_id)
%%Fit all Rect models to a channel data. 
% Error = Sum across f1 harmonics and intermodulations
...
% Save data 
% all settings 
dir_name_all_settings = './rect_top10_results_all_settings_v3/';
...
dir_name_best_setting = './rect_top10_results_best_setting_v3/';
if ~exist(dir_name_best_setting, 'dir')
    mkdir(dir_name_best_setting);
end % ~exist(dir_name_all_settings, 'dir');
file_name_best_setting = ['best_setting_rect_S', num2str(area_id), '_id_', ...
             num2str(channel_id), '.mat'];
...
%   Output: err
    ...
    foi = sort([foi_f1_harm, foi_inter]);            
