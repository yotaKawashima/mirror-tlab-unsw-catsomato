function model_sq_fit_massive_v3(channel_id, area_id)
...
% Save data 
% all settings 
dir_name_all_settings = './sq_top10_results_all_settings_v3/';
...
dir_name_best_setting = './sq_top10_results_best_setting_v3/';
