function model_rect_fit_massive_v4(channel_id, area_id)
...
% Save data 
% all settings 
dir_name_all_settings = './rect_top10_results_all_settings_v4/';
...
dir_name_best_setting = './rect_top10_results_best_setting_v4/';
