...
% Try some models for some channels.

%% Set variables
[fpath, fname, fext] = fileparts(mfilename('fullpath'));
d(fullfile(fpath, '../path_setup.m'));
...
for id_bp_ch = 1:length(bp_chans)
    % Get bipolar channel
    bp_chan = bp_chans(id_bp_ch);
    
    % Compure mean and std across trials for this channel data. 
    [mean_logsnr_1, std_logsnr_1, freq_data_1] = mean_std_data(data_dir_logsnr, catname, bp_chan);
    ...
    for model_id = 1:4        
        switch model_id 
            case 1
                ...
                % Line search
                [L_min_var1_1, L_min_var2_1, L_error_1, L_errors_1, L_coordinate_1] = ...
                    fit_model_param2(model, varmin, varmax, mean_logsnr_1, sampling_rate, iteration, tol);
            ...
            case 2
                ...
                [L_min_var1_1, L_min_var2_1, L_min_var3_1, L_error_1, L_errors_1, L_coordinate_1] = ...
                    fit_model_param3(model, varmin, varmax, mean_logsnr_1, sampling_rate, iteration, tol);
            ...
            case 4
                ...
                [L_min_var1_1, L_min_var2_1, L_min_var3_1, L_min_var4_1, L_error_1, L_errors_1, L_coordinate_1] = ...
                    fit_model_param4(model, varmin, varmax, mean_logsnr_1, sampling_rate, iteration, tol);
        end
