function model_sq_fit_massive_v2(channel_id, area_id)
...
% Save data 
% all settings 
dir_name_all_settings = './sq_top10_results_all_settings_v2/';
...
dir_name_best_setting = './sq_top10_results_best_setting_v2/';
