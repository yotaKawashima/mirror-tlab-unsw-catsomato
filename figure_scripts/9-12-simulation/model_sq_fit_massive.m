function model_sq_fit_massive(channel_id, area_id)
...
varmin = -1;
varmax = 1;
iterations = [30, 45]; % iterate 5 times for each coefficient
...
% Save data 
% all settings 
dir_name_all_settings = './sq_top10_results_all_settings/';
...
dir_name_best_setting = './sq_top10_results_best_setting/';
