...
#SBATCH --job-name=sq_top10 						# Job name
...
#SBATCH --output=./massiveOutput/sq_top10_%j.log    # Standard output and error log
...
matlab -nodisplay -r "model_sq_fit_massive_v2($channel_id, $area_id); exit;"
