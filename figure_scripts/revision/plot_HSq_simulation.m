...
% Here, we show half squaring for the rebuttal letter.
...
for i = 1:num_signals
    switch i 
        ...
        case 2%6 
            ...
            p_y = HSq_comp1;
        case 3%7 
            % Sum of two half square.
            % HSq(X)+HSq(Y)
            p_y = HSq_comp1 + HSq_comp2;
        case 4%8 
            % Half suqring after multiple
            p_y = comp1 .* comp2;
            p_y(p_y <= 0) = 0;
            p_y(p_y > 0) = p_y(p_y > 0).^2;
        case 5%9 
...
if img_fmt == "-depsc" || img_fmt == "-dpdf"   
    print(fig1, img_fmt, 'FigRev2_halfpow2models_a');
elseif img_fmt == "-dtiff" || img_fmt == "-dpng"
    print(fig1, img_fmt, 'FigRev2_halfpow2models_a', '-r300');
end
...
f.Position = [10, 10, 8, 8.5];
if img_fmt == "-depsc" || img_fmt == "-dpdf"   
    print(fig2, img_fmt, 'FigRev2_halfpow2models_b');
elseif img_fmt == "-dtiff" || img_fmt == "-dpng"
    print(fig2, img_fmt, 'FigRev2_halfpow2models_b', '-r300');
end
